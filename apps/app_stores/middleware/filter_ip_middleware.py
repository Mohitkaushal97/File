...
# based on:
# https://github.com/uktrade/dit-ip/blob/master/ip_restriction/middleware.py#L63
# changes:
# removed ranges; removed special handling for logged-in users, admins
class IpWhitelister():
    """
    ...
    def __init__(self, get_response=None):
        ...
        self.RESTRICT_IPS = self._get_config_var('IP_FILTER__RESTRICT_IPS', bool)
        self.ALLOWED_IPS = self._get_config_var('IP_FILTER__ALLOWED_IPS', list)
    ...
    def is_blocked_ip(self, request, allowed_ips):
        # Default blocked
        block_request = True
    ...
    def process_request(self, request):
        ...
        if self.RESTRICT_IPS:
            ...
            if block_request:
                ...
                # https://stackoverflow.com/a/41915722
